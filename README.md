...
[![Stable build Status](https://travis-ci.org/xinax/laravel-gettext.png?branch=3.0.2)](https://travis-ci.org/xinax/laravel-gettext) <a href="https://github.com/xinax/laravel-gettext/tree/3.0.2">Latest Laravel 5.1+ stable release (3.0.2)</a>

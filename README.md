...
Open the PO file for the language that you want to translate with PoEdit. The PO files are located by default in *resources/lang/i18n/<locale>/LC_MESSAGES/messages.po*. If you have multiple gettext domains, one file is generated by each domain.

...
[![Stable build Status](https://travis-ci.org/Belphemur/laravel-gettext.png?branch=5.0.1)](https://travis-ci.org/Belphemur/laravel-gettext) <a href="https://github.com/Belphemur/laravel-gettext/tree/5.0.1">Latest Laravel 5.4.x stable release (5.0.1)</a>
